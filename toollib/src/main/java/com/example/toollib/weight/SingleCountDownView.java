...
public class SingleCountDownView extends AppCompatTextView {
    ...
    private String text = "获取验证码", prefixText = "", timeColorHex = "#ffff5c2b", suffixText = "秒后重发";
    ...
    public SingleCountDownView startCountDown() {
        ...
        ///this.setBackgroundResource(R.drawable.registered_verification_bg);
...
///                        currentSingleCountDownView.setBackgroundResource(R.drawable.registered_verification_bg);
